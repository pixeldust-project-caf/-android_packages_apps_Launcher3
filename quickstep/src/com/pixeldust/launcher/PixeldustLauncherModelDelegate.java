...
public class PixeldustLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "PixeldustLauncherModelDelegate";
    ...
    public PixeldustLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
